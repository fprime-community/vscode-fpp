...
import com.github.fprime_community.fpp_tools.FppBundle
import com.github.fprime_community.fpp_tools.FppLspManager
import com.github.fprime_community.fpp_tools.LspConfiguration
import com.github.fprime_community.fpp_tools.util.LspCli
import com.github.fprime_community.fpp_tools.util.PlatformCompatibility
import com.github.fprime_community.fpp_tools.util.Version
import com.github.fprime_community.fpp_tools.util.withLoader
...
//                                            Add the currently selected version as though it's actually installed. If it's not, it will be marked as an error later.
                    ...
                    }.rowComment("Binaries are downloaded from <a href='https://github.com/fprime-community/fpp-tools/releases/latest'>GitHub</a> when you select a version in the download section of combobox.")
                    row {
