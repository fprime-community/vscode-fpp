"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_cynefinDiagram-MW4NZA55_mjs"],{
...
/* harmony import */ var _chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-3NCLNEKW.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-3NCLNEKW.mjs");
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-NSK5VX7P.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NSK5VX7P.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
var createDefaultData = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => ({
  domains: /* @__PURE__ */ new Map(),
  transitions: []
}), "createDefaultData");
var data = createDefaultData();
var getDomains = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => data.domains, "getDomains");
var getTransitions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => data.transitions, "getTransitions");
var setDomains = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((blocks) => {
  if (!blocks) {
    return;
  }
...
var setTransitions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((transitions) => {
  if (!transitions) {
    return;
  }
  data.transitions = transitions.filter((t) => {
    if (t.from === t.to) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_4__.log.warn(
...
var getConfig2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => {
  return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)({
    ..._chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.cynefin,
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)().cynefin
  });
}, "getConfig");
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => {
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.clear)();
...
var db = {
  ...
  clear: clear2,
  setAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccTitle,
  getAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccTitle,
  setDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.setDiagramTitle,
  getDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getDiagramTitle,
  getAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getAccDescription,
  setAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.setAccDescription
};
...
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_6__.parse)("cynefin", input);
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(seededRandom, "seededRandom");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(hashString, "hashString");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(resolveSeed, "resolveSeed");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(generateFoldPath, "generateFoldPath");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(generateHorizontalBoundary, "generateHorizontalBoundary");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(generateCliffPath, "generateCliffPath");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(generateConfusionPath, "generateConfusionPath");
...
var getDomainLayouts = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((width, height) => {
  const hw = width / 2;
  const hh = height / 2;
  return {
...
var getCynefinDomainColors = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => {
  const defaultThemeVariables = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getThemeVariables)();
  const currentConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
  const themeVariables = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(defaultThemeVariables, currentConfig.themeVariables);
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((_text, id, _version, diagram2) => {
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_4__.log.debug("Rendering Cynefin diagram");
  ...
  const svg = (0,_chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_1__.selectSvgElement)(id);
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.configureSvgSize)(svg, totalHeight, totalWidth, config.useMaxWidth ?? true);
  ...
  if (transitions.length > 0) {
    ...
    transitions.forEach((transition) => {
      ...
      if (transition.from === transition.to) {
        _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_4__.log.warn(`Cynefin renderer: skipping self-loop on domain "${transition.from}"`);
        return;
      }
...
var getCynefinTheme = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => {
  const defaultThemeVariables = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getThemeVariables)();
  const currentConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
  const themeVariables = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)(defaultThemeVariables, currentConfig.themeVariables);
  return themeVariables.cynefin;
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_cynefinDiagram-MW4NZA55_mjs.sm-webview.js.map