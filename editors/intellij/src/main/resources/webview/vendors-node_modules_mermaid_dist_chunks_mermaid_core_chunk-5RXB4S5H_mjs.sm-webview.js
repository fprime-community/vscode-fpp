"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-5RXB4S5H_mjs"],{
...
/* harmony import */ var _chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-2GRJ4B5K.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-2GRJ4B5K.mjs");
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  ...
  const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)();
  if (config.look === "neo") {
  ...
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.utils_default.insertTitle(
    svg,
    "statediagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_1__.setupViewPortForSVG)(svg, padding, CSS_DIAGRAM, conf?.useMaxWidth ?? true);
}, "draw");
      ...
      case STMT_RELATION:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(item.description ?? "", (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()),
  ...
  if (itemId !== "root") {
    ...
    if (!nodeDb.get(itemId)) {
      nodeDb.set(itemId, {
        id: itemId,
        shape,
        description: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(itemId, config),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeTextOrArray(newNode.description, config);
    }
...
var StateDB = class {
  constructor(version) {
    ...
    this.funs = [];
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getAccTitle;
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setAccTitle;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getAccDescription;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setAccDescription;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setDiagramTitle;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getDiagramTitle;
    this.clear();
  ...
  docTranslator(parent, node, first) {
    ...
    if (doc.length > 0 && currentDoc.length > 0) {
      const newNode = {
        stmt: STMT_STATE,
        id: (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.generateId)(),
        type: "divider",
  ...
  addState(id, type = DEFAULT_STATE_TYPE, doc = void 0, descr = void 0, note = void 0, classes = void 0, styles = void 0, textStyles = void 0) {
    ...
    if (note) {
      ...
      doc2.note = note;
      doc2.note.text = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(doc2.note.text, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)());
    }
    if (classes) {
  ...
  addRelationObjs(item1, item2, relationTitle = "") {
    ...
    this.currentDocument.relations.push({
      id1,
      id2,
      relationTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(relationTitle, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)())
    });
  }
  /**
  ...
  addRelation(item1, item2, title) {
    if (typeof item1 === "object" && typeof item2 === "object") {
      ...
      this.currentDocument.relations.push({
        id1,
        id2,
        relationTitle: title ? _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(title, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()) : void 0
      });
    }
  }
  addDescription(id, descr) {
    ...
    theState?.descriptions?.push(_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.common_default.sanitizeText(_descr, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()));
  }
  cleanupLabel(label) {
  ...
  setupToolTips(element) {
    const tooltipElem = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_3__.createTooltip)();
  ...
  getConfig() {
    return (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)().state;
  }
};
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-5RXB4S5H_mjs.sm-webview.js.map