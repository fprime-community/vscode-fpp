"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-GF5L2VYU_mjs"],{
...
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-NSK5VX7P.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NSK5VX7P.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
var ClassMember = class {
  ...
  constructor(input, memberType) {
    ...
    this.classifier = "";
    this.text = "";
    const sanitizedInput = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.sanitizeText)(input, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.parseGenericTypes)(this.returnType);
      }
    }
...
var classCounter = 0;
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__.__name)((txt) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(txt, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)()), "sanitizeText");
var ClassDB = class _ClassDB {
  constructor() {
    ...
    this.setupToolTips = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__.__name)((element) => {
      const tooltipElem = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_4__.createTooltip)();
    ...
    this.direction = "TB";
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.setAccTitle;
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getAccTitle;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.setAccDescription;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getAccDescription;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.setDiagramTitle;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getDiagramTitle;
    this.getConfig = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__.__name)(() => (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)().class, "getConfig");
  ...
  splitClassNameAndType(_id) {
    const id = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(_id, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    let genericType = "";
    let className = id;
    if (id.indexOf("~") > 0) {
  ...
  addClass(_id) {
    ...
    const name = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(className, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
  ...
  clear() {
    ...
    this.diagramId = "";
    this.direction = "TB";
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.clear)();
  }
  getClass(id) {
  ...
  addRelation(classRelation) {
    ...
    classRelation.relationTitle1 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(
      classRelation.relationTitle1.trim(),
      (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)()
    );
    classRelation.relationTitle2 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(
  ...
  setLink(ids, linkStr, target) {
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
    ids.split(",").forEach((_id) => {
      let id = _id;
      if (/\d/.exec(_id[0])) {
        id = MERMAID_DOM_ID_PREFIX + id;
      ...
      if (theClass) {
        theClass.link = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.formatUrl(linkStr, config);
  ...
  setClickFunc(_domId, functionName, functionArgs) {
    const domId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.common_default.sanitizeText(_domId, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)());
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
      ...
      this.functions.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  getData() {
    ...
    for (const classRelation of this.relations) {
      cnt++;
      const edge = {
        id: (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__.getEdgeId)(classRelation.id1, classRelation.id2, {
          prefix: "id",
          counter: cnt
        }),
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_8__.__name)(async function(text, id, _version, diag) {
  ...
  const { securityLevel, state: conf, layout } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_6__.getConfig2)();
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_3__.getRegisteredLayoutAlgorithm)(layout);
  data4Layout.nodeSpacing = conf?.nodeSpacing || 50;
  data4Layout.rankSpacing = conf?.rankSpacing || 50;
  data4Layout.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"];
  data4Layout.diagramId = id;
  await (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_3__.render)(data4Layout, svg);
  const padding = 8;
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_5__.utils_default.insertTitle(
    svg,
    "classDiagramTitleText",
    conf?.titleTopMargin ?? 25,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_2__.setupViewPortForSVG)(svg, padding, "classDiagram", conf?.useMaxWidth ?? true);
}, "draw");
...
var setupViewPortForSVG = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_2__.__name)((svg, padding, cssDiagram, useMaxWidth) => {
  ...
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_0__.configureSvgSize)(svg, height, width, useMaxWidth);
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-GF5L2VYU_mjs.sm-webview.js.map