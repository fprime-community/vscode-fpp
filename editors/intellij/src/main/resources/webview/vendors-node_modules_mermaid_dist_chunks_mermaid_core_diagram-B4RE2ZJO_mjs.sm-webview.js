"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_diagram-B4RE2ZJO_mjs"],{
...
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-NSK5VX7P.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NSK5VX7P.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
// src/diagrams/eventmodeling/db.ts
var setOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(_rawOptString) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("options str", _rawOptString);
}, "setOptions");
var getOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function() {
  return {};
}, "getOptions");
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function() {
  reset();
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.clear)();
}, "clear");
function reset() {
  store = {};
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(reset, "reset");
var DEFAULT_EVENTMODELING_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.defaultConfig_default.eventmodeling;
var getConfig3 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(() => {
  const config = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__.cleanAndMerge)({
    ...DEFAULT_EVENTMODELING_CONFIG,
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig)().eventmodeling
  });
  return config;
}, "getConfig");
var store = {};
function getState() {
  ...
  ast.frames.forEach((frame, index) => {
    ...
    if (hasSourceFrame(frame)) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(`source frame`, frame.sourceFrames);
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(getState, "getState");
function setAst(ast) {
  store.ast = ast;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(setAst, "setAst");
var diagramProps = {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(getDiagramProps, "getDiagramProps");
var initial = {
  boxes: [],
  swimlanes: {},
  relations: [],
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(extractNamespace, "extractNamespace");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(extractName, "extractName");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(findSwimlaneByNamespace, "findSwimlaneByNamespace");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(findNextAvailableIndex, "findNextAvailableIndex");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(calculateSwimlaneProps, "calculateSwimlaneProps");
function calculateEntityVisualProps(frame) {
  const { themeVariables } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig)();
  switch (frame.modelEntityType) {
    case "ui":
      return {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(calculateEntityVisualProps, "calculateEntityVisualProps");
function calculateTextProps(frame, dataEntities, diagramProps2) {
  const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig)();
  const name = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.sanitizeText)(extractName(frame.entityIdentifier) ?? "", config);
  let toHtml;
  ...
  const wrappedName = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__.wrapLabel)(name, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  if (frame.dataInlineValue) {
    ...
    toHtml = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.sanitizeText)(toHtml, config);
    toHtml = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__.wrapLabel)(toHtml, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  const dimensions = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__.calculateTextDimensions)(content, textDimensionConfig);
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(`[${frame.name}] ${frame.entityIdentifier} text`, props);
  return props;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(calculateTextProps, "calculateTextProps");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(decidePositionFrame, "decidePositionFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(calculateX, "calculateX");
function calculateMaxRight(swimlanes, swimlaneR) {
  const rs = [...swimlanes.map((s) => s.r), swimlaneR];
  return Math.max(...rs);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(calculateMaxRight, "calculateMaxRight");
function sortedSwimlanesArray(swimlanes) {
  return Object.values(swimlanes).sort((a, b) => a.index - b.index);
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(sortedSwimlanesArray, "sortedSwimlanesArray");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(evolveFramePositioned, "evolveFramePositioned");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(isFirstFrame, "isFirstFrame");
function hasSourceFrame(frame) {
  return frame.sourceFrames !== void 0 && frame.sourceFrames !== null && frame.sourceFrames.length > 0;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(hasSourceFrame, "hasSourceFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(findBoxByFrame, "findBoxByFrame");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(findBoxByLineIndex, "findBoxByLineIndex");
function decidePositionRelation(state, _command) {
  const command = _command;
  if ((0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__.isEmResetFrame)(command.frame) || isFirstFrame(command.index, command.frame)) {
    return [];
  }
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(decidePositionRelation, "decidePositionRelation");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(evolveRelationPositioned, "evolveRelationPositioned");
var deciders = {
...
function decide(state, command) {
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(`decided events`, events);
  return events;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(decide, "decide");
function evolve(state, events) {
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(`evolve events`, { state, newState, events });
  return newState;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(evolve, "evolve");
function dispatch(state, command) {
  const events = decide(state, command);
  const newState = evolve(state, events);
  return newState;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(dispatch, "dispatch");
var db = {
  getConfig: getConfig3,
  setOptions,
  getOptions,
  clear: clear2,
  setAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.setAccTitle,
  getAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getAccTitle,
  getAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getAccDescription,
  setAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.setAccDescription,
  setDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.setDiagramTitle,
  getDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getDiagramTitle,
  setAst,
  getDiagramProps,
  getState
};
...
// src/diagrams/eventmodeling/parser.ts
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(async (input) => {
    const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_5__.parse)("eventmodeling", input);
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(ast);
    db.setAst(ast);
...
var DEFAULT_CONFIG = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig2)();
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(renderD3Box, "renderD3Box");
function dirUpwards(sourceY, targetY) {
  return sourceY > targetY;
}
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(dirUpwards, "dirUpwards");
function renderD3Relation(diagram2, diagramProps2, arrowheadId, themeVariables) {
  return (relation) => {
    ...
    let sourceY;
    let targetY;
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug(`rendering relation up=${upwards} for `, {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(renderD3Relation, "renderD3Relation");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(renderD3Swimlane, "renderD3Swimlane");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)(function(txt, id, ver, diagObj) {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__.log.debug("in eventmodeling renderer", txt + "\n", "id:", id, ver);
  if (!DEFAULT_EVENTMODELING_CONFIG2) {
    throw new Error("EventModeling config not found");
  }
  const db2 = diagObj.db;
  const { themeVariables, eventmodeling: config } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.getConfig2)();
  ...
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__.setupGraphViewbox2)(void 0, diagram2, config?.padding ?? 30, config?.useMaxWidth);
}, "draw");
...
var getStyles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__.__name)((_options) => ``, "getStyles");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_diagram-B4RE2ZJO_mjs.sm-webview.js.map