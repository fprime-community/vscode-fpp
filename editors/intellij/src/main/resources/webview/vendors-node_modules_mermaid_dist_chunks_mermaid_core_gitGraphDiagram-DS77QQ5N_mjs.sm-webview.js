"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-DS77QQ5N_mjs"],{
...
var DEFAULT_GITGRAPH_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.defaultConfig_default.gitGraph;
var getConfig3 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(() => {
  const config = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.cleanAndMerge)({
    ...DEFAULT_GITGRAPH_CONFIG,
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)().gitGraph
  });
  return config;
}, "getConfig");
...
function getID() {
  return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.random)({ length: 7 });
}
...
var commit = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(commitDB) {
  ...
  const config = getConfig3();
  id = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(id, config);
  msg = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(msg, config);
  tags = tags?.map((tag) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  const newCommit = {
...
var branch = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(branchDB) {
  ...
  name = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(name, getConfig3());
...
var merge = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((mergeDB) => {
  ...
  const config = getConfig3();
  otherBranch = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(otherBranch, config);
  if (customId) {
    customId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(customId, config);
  }
...
var cherryPick = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(cherryPickDB) {
  ...
  const config = getConfig3();
  sourceId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(sourceId, config);
  targetId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(targetId, config);
  tags = tags?.map((tag) => _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(tag, config));
  parentCommitId = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(parentCommitId, config);
...
var checkout = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(branch2) {
  branch2 = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.common_default.sanitizeText(branch2, getConfig3());
...
var drawCommitBullet = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((gBullets, commit2, commitPosition, typeClass, branchIndex, commitSymbolType) => {
  const { theme } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
...
var getCommitPosition = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((commit2, pos, isParallelCommits) => {
  ...
  const useReduxGeometry = REDUX_GEOMETRY_THEMES.has((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)().theme ?? "");
...
var drawArrow = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((svg, commitA, commitB, allCommits) => {
  const { theme: arrowTheme } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
...
var drawBranches = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((svg, branches, gitGraphConfig, id) => {
  const { look, theme, themeVariables } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig2)();
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)(function(txt, id, ver, diagObj) {
  ...
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_2__.utils_default.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin ?? 0,
    db2.getDiagramTitle()
  );
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.setupGraphViewbox2)(void 0, diagram2, gitGraphConfig.diagramPadding, gitGraphConfig.useMaxWidth);
}, "draw");
...
var genColor = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_5__.__name)((options) => {
  const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_3__.getConfig)();
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_gitGraphDiagram-DS77QQ5N_mjs.sm-webview.js.map