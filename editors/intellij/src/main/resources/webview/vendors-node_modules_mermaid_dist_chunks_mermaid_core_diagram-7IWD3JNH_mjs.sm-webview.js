"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_diagram-7IWD3JNH_mjs"],{
...
/* harmony import */ var _chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-3NCLNEKW.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-3NCLNEKW.mjs");
/* harmony import */ var _chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chunk-4I5QYGJK.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-4I5QYGJK.mjs");
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-NSK5VX7P.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NSK5VX7P.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(isBoxDrawingFormat, "isBoxDrawingFormat");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(inferSegmentWidth, "inferSegmentWidth");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(remapErrorLines, "remapErrorLines");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(preprocessBoxDrawing, "preprocessBoxDrawing");
...
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(() => {
  state.reset();
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.clear)();
}, "clear");
var getRoot = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(() => {
  return state.records.stack[0];
}, "getRoot");
var getCount = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(() => state.records.cnt, "getCount");
var defaultConfig = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.defaultConfig_default.treeView;
var getConfig2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(() => {
  return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.cleanAndMerge)(defaultConfig, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)().treeView);
}, "getConfig");
var addNode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((level, name, nodeType, cssClass, icon, description) => {
...
var db = {
  ...
  getAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getAccTitle,
  getAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getAccDescription,
  getDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getDiagramTitle,
  setAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setAccDescription,
  setAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setAccTitle,
  setDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setDiagramTitle
};
var db_default = db;

// src/diagrams/treeView/parser.ts
var populate = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((ast) => {
  (0,_chunk_JWPE2WC7_mjs__WEBPACK_IMPORTED_MODULE_1__.populateCommonDb)(ast, db_default);
  for (const node of ast.nodes) {
    ...
    const description = rawDesc ? (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.sanitizeText)(rawDesc, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)()) : void 0;
...
var parser = {
  parse: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async (input) => {
    ...
    try {
      const ast = await (0,_mermaid_js_parser__WEBPACK_IMPORTED_MODULE_8__.parse)("treeView", text);
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(detectIcon, "detectIcon");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(qualifyIcon, "qualifyIcon");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(getNodeIcon, "getNodeIcon");

// src/diagrams/treeView/renderer.ts
(0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.registerIconPacks)([
  {
...
var ICON_GAP = 4;
var DESC_GAP = 16;
var iconSymbolId = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((diagramId, icon) => `tv-icon-${diagramId}-${icon.replace(/[^\w-]/g, "-")}`, "iconSymbolId");
var injectIconDefs = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async (svg, root, config, diagramId) => {
  const usedIcons = /* @__PURE__ */ new Set();
  const collect = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((node) => {
  ...
  const iconSVGs = await Promise.all(
    [...usedIcons].map(async (icon) => ({
      icon,
      svg: await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.getIconSVG)(icon, {
        height: ICON_SIZE,
        width: ICON_SIZE
      })
    }))
...
var positionLabel = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((x, y, node, domElem, config, diagramId) => {
...
var positionLine = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((domElem, x1, y1, x2, y2, lineThickness) => {
...
var drawTree = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((elem, root, config, diagramId) => {
  let totalHeight = 0;
  let totalWidth = 0;
  const renderInfos = [];
  const drawNode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((elem2, node, config2, depth) => {
  ...
  const processNode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((node, depth = 0) => {
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async (text, id, _ver, diagObj) => {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_6__.log.debug("Rendering treeView diagram\n" + text);
  const db2 = diagObj.db;
  const root = db2.getRoot();
  const config = db2.getConfig();
  const svg = (0,_chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_2__.selectSvgElement)(id);
  ...
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.configureSvgSize)(svg, totalHeight, totalWidth, config.useMaxWidth);
}, "draw");
var renderer = {
  draw
};
...
var styles = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(({
  treeView
}) => {
  const {
    labelFontSize,
    ...
    highlightBg,
    highlightStroke
  } = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.cleanAndMerge)(defaultTreeViewDiagramStyles, treeView);
  return `
    .treeView-node-label {
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_diagram-7IWD3JNH_mjs.sm-webview.js.map