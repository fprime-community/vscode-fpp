"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-JQJVKLGR_mjs"],{
...
/* harmony import */ var _chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chunk-J7OUQ5F2.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-J7OUQ5F2.mjs");
/* harmony import */ var _chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chunk-2GRJ4B5K.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-2GRJ4B5K.mjs");
...
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chunk-NSK5VX7P.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-NSK5VX7P.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
var FlowDB = class {
  ...
  constructor() {
    ...
    this.config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
    this.diagramId = "";
    ...
    this.funs = [];
    this.setAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.setAccTitle;
    this.setAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.setAccDescription;
    this.setDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.setDiagramTitle;
    this.getAccTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getAccTitle;
    this.getAccDescription = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getAccDescription;
    this.getDiagramTitle = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getDiagramTitle;
  ...
  sanitizeText(txt) {
    return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.common_default.sanitizeText(txt, this.config);
  }
  ...
  addVertex(id, textObj, type, style, classes, dir, props = {}, metadata) {
    ...
    if (doc !== void 0) {
      if (doc.shape) {
        ...
        } else if (!(0,_chunk_QR6OTTB3_mjs__WEBPACK_IMPORTED_MODULE_6__.isValidShape)(doc.shape)) {
  ...
  addSingleLink(_start, _end, type, id) {
    ...
    if (id && !this.edges.some((e) => e.id === id)) {
      ...
      if (existingLinks.length === 0) {
        edge.id = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.getEdgeId)(edge.start, edge.end, { counter: 0, prefix: "L" });
      } else {
        edge.id = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.getEdgeId)(edge.start, edge.end, {
...
You have to call mermaid.initialize.`
  ...
  setClickFun(id, functionName, functionArgs) {
    if ((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)().securityLevel !== "loose") {
      return;
    }
      ...
      this.funs.push(() => {
        ...
        if (elem !== null) {
          elem.addEventListener(
            "click",
            () => {
              _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.utils_default.runFunc(functionName, ...argList);
            },
            false
          );
        }
  ...
  setLink(ids, linkStr, target) {
    ids.split(",").forEach((id) => {
      const vertex = this.vertices.get(id);
      if (vertex !== void 0) {
        vertex.link = _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.utils_default.formatUrl(linkStr, this.config);
  ...
  setupToolTips(element) {
    const tooltipElem = (0,_chunk_2GRJ4B5K_mjs__WEBPACK_IMPORTED_MODULE_5__.createTooltip)();
  ...
  clear(ver = "gen-2") {
    ...
    this.version = ver;
    this.config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.clear)();
  }
  setGen(ver) {
  ...
  addSubGraph(_id, list, _title) {
    ...
    const flowchartConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)().flowchart ?? {};
    const dir = rawDir ?? (flowchartConfig.inheritDir ? this.getDirection() ?? (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)().direction ?? void 0 : void 0);
  ...
  getData() {
    const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
    const nodes = [];
    const edges = [];
    ...
    e.forEach((rawEdge, index) => {
      ...
      const edge = {
        id: (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.getEdgeId)(rawEdge.start, rawEdge.end, { counter: index, prefix: "L" }, rawEdge.id),
  ...
  defaultConfig() {
    return _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.defaultConfig2.flowchart;
  }
};
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(async function(text, id, _version, diag, positions) {
  ...
  const { securityLevel, flowchart: conf, layout } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getConfig2)();
  ...
  data4Layout.layoutAlgorithm = (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__.getRegisteredLayoutAlgorithm)(layout);
  ...
  await (0,_chunk_J7OUQ5F2_mjs__WEBPACK_IMPORTED_MODULE_4__.render)(data4Layout, svg, positions);
  const padding = data4Layout.config.flowchart?.diagramPadding ?? 8;
  _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_7__.utils_default.insertTitle(
    svg,
    "flowchartTitleText",
    conf?.titleTopMargin || 0,
    diag.db.getDiagramTitle()
  );
  (0,_chunk_KBJHAD2P_mjs__WEBPACK_IMPORTED_MODULE_2__.setupViewPortForSVG)(svg, padding, "flowchart", conf?.useMaxWidth || false);
}, "draw");
...
var createFlowDiagram = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)(({
  ...
  init: /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_10__.__name)((cnf) => {
    ...
    const layout = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.getUserDefinedConfig)().layout ?? defaultLayout ?? cnf.layout;
    if (layout) {
      (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.setConfig2)({ layout });
    }
    cnf.flowchart.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_8__.setConfig2)({ flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } });
  }, "init")
}), "createFlowDiagram");
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-JQJVKLGR_mjs.sm-webview.js.map