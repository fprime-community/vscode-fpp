(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_architectureDiagram-T3A2C74G_mjs"],{
...
/* harmony import */ var _chunk_WRU74C26_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chunk-WRU74C26.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-WRU74C26.mjs");
...
var architectureGroupAlignmentKey = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((groupA, groupB) => {
...
var DEFAULT_ARCHITECTURE_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.defaultConfig_default.architecture;
var ArchitectureDB = class {
  ...
  getConfig() {
    return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.cleanAndMerge)({
      ...DEFAULT_ARCHITECTURE_CONFIG,
      ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig)().architecture
    });
  }
...
var architectureIcons = {
  ...
  icons: {
    ...
    unknown: _chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.unknownIcon,
    blank: {
      body: wrapIcon("")
    }
  }
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", `${diagramId}-${(0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__.getEdgeId)(source, target, { prefix: "L" })}`);
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0,_chunk_WRU74C26_mjs__WEBPACK_IMPORTED_MODULE_2__.createText)(
            textElem,
            label,
            {
              useHtmlLabels: false,
            ...
            (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.getConfig2)()
          );
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.getIconSVG)(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async function(db, elem, services, diagramId) {
  ...
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.getIconSVG)(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__.getIconSVG)("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.sanitizeText)(service.iconText, config));
...
function getAlignments(db, spatialMaps, groupAlignments, layoutHints = []) {
  const flattenAlignments = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)((alignmentMap, alignmentDir) => {
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__.__name)(async (text, id, _version, diagObj) => {
  ...
  positionNodes(db, cy);
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__.setupGraphViewbox)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_architectureDiagram-T3A2C74G_mjs.sm-webview.js.map