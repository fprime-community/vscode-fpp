"use strict";
(self["webpackChunkfpp"] = self["webpackChunkfpp"] || []).push([["vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-6Q2QTUOP_mjs-node_modules_mermaid-43ff09"],{
...
/* harmony export */ });
/* harmony import */ var _chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chunk-3NCLNEKW.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-3NCLNEKW.mjs");
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chunk-I66GZJ75.mjs */ "./node_modules/mermaid/dist/chunks/mermaid.core/chunk-I66GZJ75.mjs");
...
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((text) => {
  return (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.sanitizeText)(text, (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig2)());
}, "sanitizeText");
var sanitizeAstNode = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((node) => {
  switch (node.type) {
    case "terminal":
...
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  diagramTitle = "";
  accTitle = "";
  accDescription = "";
  rules.length = 0;
  ruleMap.clear();
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.clear)();
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Database cleared");
}, "clear");
var setTitle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((text) => {
  diagramTitle = sanitizeText2(text);
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Title set:", text);
}, "setTitle");
var getTitle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  return diagramTitle;
}, "getTitle");
var addRule = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((rule) => {
  const sanitizedRule = {
    ...rule,
  ...
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Adding rule:", sanitizedRule.name);
  if (ruleMap.has(sanitizedRule.name)) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.warn(`[Railroad] Rule '${sanitizedRule.name}' is already defined. Overwriting.`);
  }
  rules.push(sanitizedRule);
  ruleMap.set(sanitizedRule.name, sanitizedRule);
}, "addRule");
var getRules = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  return rules;
}, "getRules");
var getRule = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((name) => {
  return ruleMap.get(name);
}, "getRule");
var setAccTitle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((text) => {
  accTitle = sanitizeText2(text).replace(/^\s+/g, "");
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Accessibility title set:", text);
}, "setAccTitle");
var getAccTitle = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
  return accTitle;
}, "getAccTitle");
var setAccDescription = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((text) => {
  accDescription = sanitizeText2(text).replace(/\n\s+/g, "\n");
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Accessibility description set:", text);
}, "setAccDescription");
var getAccDescription = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(() => {
...
var isRailroadStyleOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((options) => {
  if (!options) {
    return false;
  }
...
var extractRailroadOverrides = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((options) => {
  if (!options) {
    return {};
  }
...
var extractThemeOverrides = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((options) => {
...
var sanitizeColorValue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((value, fallback) => {
...
var sanitizeFontFamilyValue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((value, fallback) => {
  if (typeof value !== "string") {
    return fallback;
  }
  const normalized = value.trim();
...
var sanitizeNumberValue = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((value, fallback) => {
  const parsed = typeof value === "number" ? value : typeof value === "string" ? Number.parseFloat(value) : Number.NaN;
  return Number.isFinite(parsed) && parsed >= 0 ? parsed : fallback;
}, "sanitizeNumberValue");
var parseThemeFontSize = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((value) => {
  const parsed = typeof value === "number" ? value : typeof value === "string" ? Number.parseFloat(value) : Number.NaN;
  return Number.isFinite(parsed) && parsed > 0 ? parsed : void 0;
}, "parseThemeFontSize");
var buildThemeDefaults = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((themeVariables) => {
...
var buildRailroadStyleOptions = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((options) => {
  const currentConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig)();
  const themeVariables = {
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.getThemeVariables)(),
...
var PathBuilder = class {
  ...
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(this, "PathBuilder");
  }
  moveTo(x, y) {
    this.d += `M ${x} ${y} `;
    return this;
...
var RailroadRenderer = class {
  ...
  static {
    (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)(this, "RailroadRenderer");
  }
  /**
...
var configureRailroadSvgSize = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((svg, dimensions, useMaxWidth) => {
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.configureSvgSize)(svg, dimensions.height, dimensions.width, useMaxWidth);
  svg.attr("viewBox", `0 0 ${dimensions.width} ${dimensions.height}`);
}, "configureRailroadSvgSize");
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_3__.__name)((text, id, _version) => {
  _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Rendering diagram\n" + text);
  try {
    const svg = (0,_chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_0__.selectSvgElement)(id);
    svg.attr("class", "railroad-diagram");
    const railroadConfig = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_1__.getConfig)().railroad;
    const useMaxWidth = railroadConfig?.useMaxWidth ?? true;
    const rules2 = db.getRules();
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug(`[Railroad] Rendering ${rules2.length} rules`);
    if (rules2.length === 0) {
      _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.warn("[Railroad] No rules to render");
    ...
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.debug("[Railroad] Render complete");
  } catch (error) {
    _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_2__.log.error("[Railroad] Render error:", error);
    throw error;
  }
}, "draw");
var renderer = { draw };
...
//# sourceMappingURL=vendors-node_modules_mermaid_dist_chunks_mermaid_core_chunk-6Q2QTUOP_mjs-node_modules_mermaid-43ff09.sm-webview.js.map