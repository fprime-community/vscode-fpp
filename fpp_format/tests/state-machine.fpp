...
on   tick   enter   Idle
  ...
  state  Waiting  {
      @ Choice definition
choice   CheckCondition   {  if   isReady  enter   Active  else  enter   Idle  }
...
choice  C1  {  if  g1  do {a1}  enter  S2  else  do{a2}  enter  S3  }

choice  C2  {  if  g2  do { a1, a2, a3 }  enter  S2  else  enter  S3  }
